...
<body>
    ...
    <div class="flex">
        <?php require 'templates/cashier_navbar.php' ?>
                        ...
                        <div id="cardItemsContainer" class="flex-grow" style="overflow-y: auto;">
                            <template x-for="cart in carts">
                                <div class="cart-item">
                                    ...
                                    <span class="right" x-text="('KES' + cart.quantity * cart.product.price)"></span>
                                </div>                                
                            </template>
                        </div>

                        <form action="controllers/cashier_controller.php" method="POST" @submit="validate">
                            ...
                            <div>
                                ...
                                <span class="font-bold" x-text="'KES' + totalPrice"></span>
                            </div>
